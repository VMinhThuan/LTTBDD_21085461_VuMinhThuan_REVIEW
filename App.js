...
export default function App() {
   ...
   useEffect(() => {
    axios.get('https://671c355a2c842d92c382621e.mockapi.io/category/21085461_VuMinhThuan').then((response) => {
      setCategory(response.data);
    });
    axios.get('https://671c355a2c842d92c382621e.mockapi.io/location/').then((response) => {
      ...
      <View style={styles.container}>
        ...
        />
         ...
         <View style={styles.sectionContainer}>
                    ...
                    <Image source={require('./assets/3gach.png')} style={styles.icon3gachlocation}/>
                </View>
                <FlatList
